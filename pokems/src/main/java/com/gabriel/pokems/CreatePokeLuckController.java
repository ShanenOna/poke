...
public class CreatePokeLuckController extends GenericPokeLuckController {
	...
	public void onSubmit(ActionEvent actionEvent) {
		try {
			PokeLuck pokeLuck = toObject(false);
			PokeLuck newPokeLuck = PokeLuckService.getService().create(pokeLuck);
			managePokeLuckController.refresh();
